package com.shuttleclone.userapp;
...
import com.shuttleclone.userapp.utils.CustomToast;
...
import static com.shuttleclone.userapp.utils.UtilMethodsKt.getPreference;
...
public class BaseActivity extends AppCompatActivity {
    ...
    public void showToast(String aContent) {
        try {
            ...
            mylog("BaseActivity", "showToast: error="+e.getLocalizedMessage());
        }
    }
    ...
    public void loadFragment(Fragment fragment) {
        try {
            ...
            mylog("BaseActivity", "loadFragment: Error="+e.getLocalizedMessage());
        }
    }
    ...
    public String getDefaultCurrency() {
        return getPreference(this, Constants.DEFAULT_CURRENCY)+" ";
    }
}
