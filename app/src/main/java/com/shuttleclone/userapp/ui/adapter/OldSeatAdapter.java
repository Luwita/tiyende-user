...
public class OldSeatAdapter extends SelectableAdapter<RecyclerView.ViewHolder> {
    ...
    /*constructor*/
    public OldSeatAdapter(OnSeatSelected onSeatSelected, List<AbstractItem> aAbstractItems, Context aContext, List<SeatModel> aSeatModelList) {
