...
import com.shuttleclone.userapp.AppDb.Dao.RecentSearchDao_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `recent_search_table` (`pickUpLat` TEXT NOT NULL, `pickUpLng` TEXT NOT NULL, `dropLat` TEXT NOT NULL, `dropLng` TEXT NOT NULL, `pickUpAddress` TEXT NOT NULL, `dropAddress` TEXT NOT NULL, `date` TEXT NOT NULL, `dropId` TEXT NOT NULL, `pickUpId` TEXT NOT NULL, `id` INTEGER, PRIMARY KEY(`id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '241fce875bf4931a625998ab938f0bee')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsRecentSearchTable = new HashMap<String, TableInfo.Column>(10);
        ...
        _columnsRecentSearchTable.put("dropId", new TableInfo.Column("dropId", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsRecentSearchTable.put("pickUpId", new TableInfo.Column("pickUpId", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoRecentSearchTable.equals(_existingRecentSearchTable)) {
          return new RoomOpenHelper.ValidationResult(false, "recent_search_table(com.shuttleclone.userapp.AppDb.models.RecentSearchData).\n"
                  + " Expected:\n" + _infoRecentSearchTable + "\n"
                  + " Found:\n" + _existingRecentSearchTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "241fce875bf4931a625998ab938f0bee", "0875ee62d233413d030d50be33d7edec");
